...
from aisteer360.algorithms.core.execution.contracts import BackendCapabilities, Capability, UnsupportedOperationError
...
def collect_state_entries(
    ...
    Args:
        ...
        **gen_kwargs: Additional arguments passed to hook construction
...
def per_item_state_entries(
    ...
    Args:
        ...
        **gen_kwargs: Additional arguments passed to `get_hooks()`.
