...
from aisteer360.algorithms.output_control.common.logit_sources import (
    AuxModelSource,
    BaseLogitSource,
    CallableSource,
    PromptVariantSource,
...
from aisteer360.algorithms.output_control.common.values.base import BaseCandidateValue
...
def resolve_value(spec, *, model, tokenizer, device) -> BaseCandidateValue:
...
def resolve_source(spec, *, model, tokenizer) -> BaseLogitSource:
...
def resolve_scorer(spec, *, device):
