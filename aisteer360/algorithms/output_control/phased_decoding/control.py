...
class PhasedDecoding(PhasedDriver):
    ...
    Args:
        plan (list): List of phase dicts (each with exactly one of `"fixed"` or `"generate"`).
        extract_after (str | None): Tail-extraction marker; `None` keeps the full spliced stream.
