"""Tests for the state-control layout migration: vector-supplied configurations steer against a
session layout with `model=None`, and hook module names resolve from the module tree at
`get_hooks()` time."""
import pytest
import torch
